...
async function seed() {
    ...
    .values([
      {
        ...
        packageMin: "18",
        packageMax: "45",
        eligibleDepartments: ["CSE", "IT", "ETC"],
      },
      {
        name: "Microsoft",
        industry: "Technology",
      ...
      },
      {
        ...
        packageMin: "12",
        packageMax: "32",
        eligibleDepartments: ["CSE", "IT", "ETC", "ME"],
      },
      {
        ...
        packageMin: "3.5",
        packageMax: "7",
        eligibleDepartments: ["CSE", "IT", "ETC", "ME", "CE"],
      },
      {
        name: "Infosys",
        industry: "IT Services",
  ...
  if (companies.length > 0) {
    ...
    if (google)
      jobValues.push({
        ...
        status: "open",
        description:
          "Join our team to build products at scale. Work on Search, Maps, and Cloud.",
        eligibilityCriteria:
          "CGPA >= 8.0, No backlogs, CSE/IT/ETC students only",
    ...
    if (microsoft)
      jobValues.push({
        ...
        eligibilityCriteria: "CGPA >= 7.5, No backlogs, CSE/IT/ETC",
    ...
    if (amazon)
      jobValues.push({
        ...
        status: "upcoming",
        description:
          "Build and operate distributed systems that serve millions of customers.",
  ...
  if (student) {
    ...
    await db
      ...
      .values({
        ...
        linkedinUrl: "https://www.linkedin.com/in/vrushali-milke-549587343/",
      })
      .onConflictDoUpdate({
      ...
      .values([
        {
          ...
          description:
            "A full-stack web application for university placement management with AI readiness scoring.",
          techStack: ["React", "Node.js", "PostgreSQL", "TypeScript"],
          githubUrl:
            "https://github.com/milkerushali-sketch/Full-Career-Ecosystem",
        ...
        },
        {
          ...
          description:
            "Scalable e-commerce platform with product catalog, cart, and payment gateway integration.",
          techStack: ["React", "Express.js", "MongoDB", "Stripe"],
          githubUrl:
            "https://github.com/milkerushali-sketch/Ecommerce-AI-Recommendation-System",
          startDate: "2025-04",
          endDate: "2025-12",
        },
        {
          ...
          description:
            "WebSocket-based real-time chat with room support, file sharing, and message encryption.",
          techStack: ["React", "Socket.IO", "Node.js", "Redis"],
          githubUrl:
            "https://github.com/milkerushali-sketch/Real-Time-Chat-Application",
          startDate: "2025-04",
          endDate: "2025-08",
        },
      ])
    ...
    await Promise.all(
      [
        ...
        db
          ...
          .where(
            and(
              eq(projectsTable.userId, student.id),
              eq(projectsTable.title, title),
            ),
          ),
      ),
    );
      ...
      .values([
        {
          ...
          description:
            "Worked on the search ranking algorithm team. Improved search latency by 15%.",
          startDate: "2025-05",
          endDate: "2025-07",
          stipend: "40000",
          location: "Bangalore",
        },
        {
          ...
          description:
            "Built core features for a B2B SaaS product using React and Node.js.",
          startDate: "2025-12",
          endDate: "2026-01",
          stipend: "20000",
          location: "Remote",
    ...
    await db
      ...
      .values({
        userId: student.id,
        githubUsername: "vrushalimilke",
        githubUrl: "https://github.com/vrushalimilke",
        leetcodeUsername: "vrushali_codes",
        leetcodeSolved: 287,
        hackerrankUsername: "vrushalimilke",
        hackerrankBadges: 5,
        codeforcesUsername: "vrushali_milke",
      ...
      .values([
        {
          ...
          message:
            "Google India is visiting campus on March 15. Apply before March 10.",
          type: "job",
          isRead: false,
        },
        {
          ...
          message:
            "Your technical interview with Microsoft is scheduled for March 5, 2025 at 10:00 AM.",
          type: "interview",
          isRead: false,
        },
        {
          ...
          message:
            "Your AI resume analysis is ready. Your readiness score is 82/100.",
          type: "placement",
          isRead: true,
        },
      ])
  ...
  const demoStudents = [
    {
      name: "Vaibhav Khodake",
      email: "vaibhav@placepro.edu",
      cgpa: "9.1",
      batch: "2024-28",
    },
    {
      name: "Srushti Mandekar",
      email: "Srushti@placepro.edu",
      cgpa: "7.5",
      batch: "2024-28",
    },
    {
      name: "Shruti Muneshwar",
      email: "Shruti@placepro.edu",
      cgpa: "8.8",
      batch: "2024-28",
    },
    {
      name: "Kiran Kumar",
      email: "kiran@placepro.edu",
      cgpa: "6.9",
      batch: "2022-26",
    },
  ];
